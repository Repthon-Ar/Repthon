...
ZelzalVP_cmd = (
    ...
    "⪼ `.اضف صورة التوديع` بالـرد ع صـورة او ميديـا لـ اضـافة صـورة (تظهـر مـع كليشـة حظـر حمـاية الخـاص)\n\n\n"
    ...
    "⪼ `.اضف فار كليشة الحماية` بالـرد ع الكليشـة (لـ تظهـر بدلاً من كليشـة رد حمـاية الخـاص)\n"
    "⪼ `.اضف فار كليشة التوديع` بالـرد ع الكليشـة (لـ تظهـر بدلاً من كليشـة حظـر حمـاية الخـاص)\n"
    ...
    "⪼ `.اضف فار جلسة الميوزك` بالـرد ع كـود تيليثون المساعد الجديـد\n\n"
...
│ ● ᴜᴘ ᴛɪᴍᴇ ➪ {uptime}
│ ● ᴀʟɪᴠᴇ sɪɴᴇᴄ ➪ {zedda}
│ ● ᴍʏ ᴄʜᴀɴɴᴇʟ ➪ [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/ZedThon/9)
┗───────────────┛"""
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("مساعدة") and event.query.user_id == zedub.uid:
            buttons = [
                [
                    Button.url("𝗭𝗧𝗵𝗼𝗻 🎡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁", "https://t.me/ZedThon/9"),
                ],
                ...
                [
                    Button.inline("حماية المجموعات 🛗", data="groupzzz"),
                ],
                [
                ...
                [
                    Button.inline("الصيـد & التثبيت ⛳", data="ZChecker"),
                ],
                [
...
ارسـل احـد الاوامر بالاعلـى""",
        buttons=[
            [Button.inline("رجـوع", data="zmusic")],
        ],
    link_preview=False)
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر المكالمـات والميـوزك 🎸](t.me/ZedThon/9) .
**- الامـر :**
**⪼** `.شغل` + (كلمـة او رابـط) او بالـرد ع مقطـع صوتـي
**⪼** `.شغل فيديو` + (كلمـة او رابـط) او بالـرد ع مقطـع فيديـو

**- اوامـر تشغيـل اجباريـه مـع تخطـي قائمـة التشغيـل :**
**⪼** `.شغل 1` + (كلمـة او رابـط) او بالـرد ع مقطـع صوتـي
**⪼** `.شغل فيديو 1` + (كلمـة او رابـط) او بالـرد ع مقطـع فيديـو
...
**⪼ بالـرد ع كـود تيليثون حساب مساعد الميوزك الجديـد**
...
async def _(event):
    await event.edit(
        "[ᯓ 𝗭𝗧𝗵𝗼𝗻 - النشـر التڪـراري العـام (الـسوبـرات) 🎡](t.me/ZedThon/9) .\n⋆┄─┄─┄─┄┄┄──┄┄┄─┄─┄─┄⋆\n**✧ اليك عـزيـزي شـࢪوحـات اوامـر النشـر والسوبـرات :**\n\n",
        buttons=[
            #[
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر النشــر التلقــائي 🌐](t.me/ZedThon/9) .
...
ارسـل احـد الاوامـر اعـلاه""",
        buttons=[
            [Button.inline("رجـوع", data="superzzz")],
        ],
    link_preview=False)
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗭𝗧𝗵𝗼𝗻 🎡 النشـࢪ التڪࢪاࢪي](t.me/ZedThon/9) .
**⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆**
**✧ قـائمـة اوامـر السـوبـر (النشـر التلقائي) ع سـورس زدثـــون ♾ :**

`.اوامر مكرر1`
**⪼ لـ عـرض اوامـر النشـر التلقائـي (.مكرر1) المحدثه بدون بانـد ...✓**

`.اوامر مكرر2`
**⪼ لـ عـرض اوامـر النشـر التلقائـي (.مكرر2) المحدثه بدون بانـد ...✓**

`.اوامر مكرر3`
**⪼ لـ عـرض اوامـر النشـر التلقائـي (.مكرر3) المحدثه بدون بانـد ...✓**
ٴ┄─┄─┄─┄┄─┄─┄─┄─┄┄
**- امـر النشـر القديـم (.مكرر) :**
...
**⪼ او استخـدم (الامـر + ايدي السوبـر)**
...
ٴ┄─┄─┄─┄┄─┄─┄─┄─┄┄
**⪼ ماهـو الجـديـد 🚀:**
- بعـد عـدة تجارب .. اوامـر النشـر صـارت متخطيه البانـد بنسب كبيرة .. بإذن الله 🏷
1- تم اضافات تأخيرات متفاوته وعشوائيـة للنشـر ➰
2- تم اضافة تسلسل في النشـر 〰
3- اوامـر النشـر صـارت بـدون تـوقف لا تتأثر باعادة التشغيـل من هيروكـو ..♾
- إضافات جديـدة وحصريـه بسـورس زدثــون¹ فقـط 🌟""",
        buttons=[
            [Button.inline("رجـوع", data="superzzz")],
        ],
    link_preview=False)
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر تجميــع النقــاط 🛂](t.me/ZedThon/9) .
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗖𝗵𝗮𝘁𝗚𝗽𝘁 - الذكـاء الاصطناعـي 🧠](t.me/ZedThon/9) .
**⋆┄─┄─┄─┄─┄─┄─┄─┄─┄⋆**
**- الامـر :**
**⪼** `.س` + سـؤالك
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗭𝗧𝗚𝗽𝘁 - الذكـاء الاصطناعـي 🧠](t.me/ZedThon/9) .
**⋆┄─┄─┄─┄─┄─┄─┄─┄─┄⋆**
**- الامـر :**
**⪼** `.زد` + سـؤالك
...
.زد من هو مكتشف الجاذبية الارضية""",
        buttons=[
            [Button.inline("رجـوع", data="ZEDAI")],
        ],
    link_preview=False)
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗚𝗲𝗺𝗶𝗻𝗶.𝗔𝗶 - الذكـاء الاصطناعـي 🧠](t.me/ZedThon/9) .
**⋆┄─┄─┄─┄─┄─┄─┄─┄─┄⋆**
**- الامـر :**
**⪼** `.جيمي` + سـؤالك
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗣𝗵𝗼𝘁𝗼.𝗔𝗶 - الذكـاء الاصطناعـي 🧠](t.me/ZedThon/9) .
**⋆┄─┄─┄─┄─┄─┄─┄─┄─┄⋆**
**- الامـر :**
**⪼** `.ارسم` + طلبـك
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗗𝗮𝗿𝗸.𝗔𝗶 - الذكـاء الاصطناعـي 🧠](t.me/ZedThon/9) .
**⋆┄─┄─┄─┄─┄─┄─┄─┄─┄⋆**
**- الامـر :**
**⪼** `.دارك` + سـؤالك
...
async def _(event):
    await event.edit(
        ...
        buttons=[
            ...
            [Button.inline("رجـوع", data="botvr")],
        ],
    link_preview=False)
...
ارسـل الامـر   `.النظام`""",
        buttons=[
            [Button.inline("رجـوع", data="syszed")],
        ],
    link_preview=False)
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭??𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الســورس 🌐](t.me/ZedThon/9) .
**- الامـر :**
**⪼** `.ايقاف البوت`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 ??𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الســورس 🌐](t.me/ZedThon/9) .
**- الامـر :**
**⪼** `.سورس`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر المجمــوعــه¹](t.me/ZedThon/9) .
**- الامـر :**
**⪼** `.تحذير`
**⪼** `.التحذيرات`
**⪼** `.حذف فار التحذيرات`
...
**بالـرد ع شخص او باضافة معرف/ايدي الشخص للامر**""",
        buttons=[
            [Button.inline("رجـوع", data="groupv2")],
        ],
    link_preview=False)
...
async def _(event):
    await event.edit(
        ...
        buttons=[
            ...
            [Button.inline("رجـوع", data="groupzzz")],
        ],
    link_preview=False)
...
ارسـل الامـر   `.البوتات`   في مجموعتك""",
        buttons=[
            [Button.inline("رجـوع", data="grouppro")],
        ],
    link_preview=False)
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿??𝗼?? - اوامــر المجمــوعــه¹](t.me/ZedThon/9) .
**- الامـر :**
**⪼** `.قفل الاضافه`
`.فتح الاضافه`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀??𝗿𝗯𝗼𝘁 - اوامــر المجمــوعــه¹](t.me/ZedThon/9) .
**- الامـر :**
**⪼** `.قفل الانلاين`
`.فتح الانلاين`
...
ارسـل الامـر   `.الرابط`   في مجموعتك""",
        buttons=[
            [Button.inline("رجـوع", data="groupv1")],
        ],
    link_preview=False)
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲??𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/ZedThon/9) .
**- الامـر :**
**⪼** `.حذف فار رسائلي`
**⪼** `.مسح`
...
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"groupzzz")))
@check_owner
async def _(event):
    await event.edit(
        "[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر المجمــوعــه 🛗](t.me/ZedThon/9) .\n⋆┄─┄─┄─┄┄┄──┄┄┄─┄─┄─┄⋆\n**✧ اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه³ :**\n\n",
...
async def _(event):
    await event.edit(
        ...
        buttons=[
            ...
            [Button.inline("المكتوميــن", data="mutlist")],
            [
...
**- الوصـف :**
لـ كتـم شخص عام سـواء في المجمـوعـة او الخـاص
سوف ينكتم الشخص من الخاص وجميع المجموعات والقنوات التي انت مشرف فيهـا
...
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"mutlist")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر المجمــوعــه²](t.me/ZedThon/9) .
...
**- الامـر :**
**⪼** `.المكتومين`
**لـ جلب قائمـة جميـع المكتوميــن ع حسـابك**
**⪼** `.مسح المكتومين`
**لـ مسـح جميـع المكتوميــن ع حسـابك عبـر امـر واحـد**

**- الوصـف :**
لـ جلب قائمـة المكتوميــن او حذف الجميـع عبـر امـر واحـد فقـط
**هـذه الميـزة غيـر موجـوده ع سورسـات آخـرى**
**فقـط ع سـوࢪس زدثــون¹**
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر مكـافح التكــرار 🛡](t.me/ZedThon/9) .
⋆┄─┄─┄─┄┄┄──┄┄┄─┄─┄─┄⋆
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر المنــع 🚫](t.me/ZedThon/9) .
⋆┄─┄─┄─┄┄┄──┄┄┄─┄─┄─┄⋆
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
...
async def _(event):
    await event.edit(
        "[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر الاضـافه والتفليـش 👾](t.me/ZedThon/9) .\n⋆┄─┄─┄─┄┄┄──┄┄┄─┄─┄─┄⋆\n**✧ اليك عـزيـزي شـࢪوحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
او `.انضمام`   +  معـرف/رابـط القناة او المجموعة""",
        buttons=[
            [Button.inline("رجـوع", data="group0vr")],
        ],
    link_preview=False)
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر الفــارات 🧬](t.me/ZedThon/9) .\n\n**✧ اليك عـزيـزي شـࢪوحـات اوامـر الفــارات :**\n\n",
            buttons=[
                [
                    Button.inline("كليشة الفحص", data="alivevar"),
                    Button.inline("كليشة ايدي", data="iiddvars"),
                ],
                [Button.inline("كليشة حماية الخاص", data="pm_vars")],
                ...
                [Button.inline("فارات المنطقة الزمنية", data="timezone")],
                [Button.inline("بقيـة الفـارات", data="vipvars")],
                [Button.inline("القائمة الرئيسية", data="ZEDHELP")],
            ],
        link_preview=False)
    except Exception:
...
async def _(event):
    await event.edit(
        "[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر فــارات الوقتــي 🕰](t.me/ZedThon/9) .\n\n**✧ اليك عـزيـزي شـࢪوحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
            ...
            [Button.inline("رجـوع", data="varszed")],
            [Button.inline("القائمة الرئيسية", data="ZEDHELP")],
        ],
    link_preview=False)
...
بالـرد على اي رمز بالامـر   `.اضف فار رمز الوقتي`""",
        buttons=[
            [Button.inline("رجـوع", data="namevar")],
        ],
    link_preview=False)
...
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"pm_vars")))
@check_owner
async def _(event):
    await event.edit(
        "[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر فــارات حمايـة الخــاص 🛄](t.me/ZedThon/9) .\n\n**✧ اليك عـزيـزي شـࢪوحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
**بالـرد على عدد بالامـر**   `.اضف فار عدد التحذيرات`""",
        buttons=[
            [Button.inline("رجـوع", data="pm_vars")],
        ],
    link_preview=False)
...
**بالـرد على الكليشـه بالامـر**   `.اضف فار كليشة الحماية`""",
        buttons=[
            [Button.url("قناة كلايش الحماية", url="https://t.me/zzkrr/6")],
            [Button.inline("رجـوع", data="pm_vars")],
        ],
    link_preview=False)
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر فــارات الفحـص 🏮](t.me/ZedThon/9) .
**- الامـر :**
**⪼** `.اضف فار كليشة الفحص`
**• بالـرد ع كليشـة من القناة @zzclll**

**⪼** `.اضف صورة الفحص`
**• بالـرد ع صورة او فيديو او متحركة من اختيارك**

**⪼** `.اضف وسائط الفحص`
**• بالـرد ع ميديا تحتها نص https://t.me/zzclll/7**


**- الوصـف :**
لـ تغيير الكليشة (الكلام) التي تظهر عندما ترسل امر (.فحص) او الصورة او كلاهما معـاً بـ امر واحد فقط

**- ملاحظـة :**
هناك متغيرات ضرورية موجوده في الكلايش لا تقم بتغييرها""",
        buttons=[
            [Button.url("قناة كلايش الفحص", url="https://t.me/zzclll/7")],
            [Button.inline("رجـوع", data="varszed")],
        ],
    link_preview=False)

@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"iiddvars")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر كلايـش الايـدي 🏮](t.me/ZedThon/9) .
**- الامـر :**
**⪼** `.اضف فار كليشة الايدي`
**• بالـرد ع كليشـة من القناة https://t.me/zziddd/4**

**- الوصـف :**
لـ تغيير الكليشة (الكلام) التي تظهر عندما ترسل امر (.ايدي) بـ امر واحد فقط

**- ملاحظـة :**
هناك متغيرات ضرورية موجوده في الكلايش لا تقم بتغييرها""",
        buttons=[
            [Button.url("قناة كلايش الايدي", url="https://t.me/zziddd/4")],
            [Button.inline("رجـوع", data="varszed")],
        ],
    link_preview=False)

@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"vipvars")))
@check_owner
async def _(event):
    await event.edit(ZelzalVP_cmd,
        buttons=[
            [Button.url("قناة الفــارات", url="https://t.me/zzzvrr")],
            [Button.inline("رجـوع", data="varszed")],
        ],
    link_preview=False)
...
`.بحث حسين الجسمي احبك`""",
        buttons=[
            [Button.inline("رجـوع", data="zdownload")],
        ],
    link_preview=False)
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧??𝗼𝗻 - اوامــر البحـث والتحميــل 🛰](t.me/ZedThon/9) .
**- الامـر :**
**⪼** `.تيك`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر تحميـل الكتب 📕](t.me/ZedThon/9) .
**- الامـر :**
**⪼** `.كتاب`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر بحـث تيليـجـرام 🛰](t.me/ZedThon/9) .
**- الامـر :**
**⪼** `.تلي` **+ كلمـة**
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر التسليـه والتحشيش 🏂🎃](t.me/ZedThon/9) .\n\n**✧ اليك عـزيـزي شـࢪوحـات اوامـر التسليـه والتحشيش :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر التسليـه 🏂](t.me/ZedThon/9) .
**⪼** `.تسليه1`
**⪼** `.تسليه2`
**⪼** `.تسليه3`
**⪼** `.تسليه4`
...
لا تقم بتكرار هذه الاوامـر او استخدامهـا بكثـره حتى لا يحدث تعليق لحسابك""",
        buttons=[
            [Button.inline("رجـوع", data="funzed")],
        ],
    link_preview=False)
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر التحشيش 🎃](t.me/ZedThon/9) .
**- الامـر :**
**⪼** `.رفع تاج`
**⪼** `.رفع بقلبي`
**⪼** `.رفع مرتي`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر الالـعــاب 🎮🎳](t.me/ZedThon/9) .
**- الامـر :**
**⪼** `.العاب الجماعي`
...
**الامـر (** `.للمجموعات` **) بالــࢪد ؏ــلى ࢪســالة نصيــه او وسـائــط تحتهــا نــص**""",
        buttons=[
            [Button.inline("رجـوع", data="broadcastz")],
        ],
    link_preview=False)
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼?? - اوامــر الإذاعــة العـامـة 🏟️](t.me/ZedThon/9) .
**- الامـر :**
**⪼** `.للكل`
...
بقيـة الاوامـر في الاعلـى""",
        buttons=[
            [Button.inline("رجـوع", data="nextacc")],
        ],
    link_preview=False)
...
بقيـة الاوامـر في الاعلـى""",
        buttons=[
            [Button.inline("رجـوع", data="next2acc")],
        ],
    link_preview=False)
...
`.انهاء البايو`""",
        buttons=[
            [Button.inline("رجـوع", data="acccount")],
        ],
    link_preview=False)
...
async def _(event):
    await event.edit(
        """[ᯓ ??𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر حمـايــة الخــاص 🛡](t.me/ZedThon/9) .
**⪼** `.الحمايه تفعيل`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - فــارات حمـايــة الخــاص 🛡](t.me/ZedThon/9) .
**⪼** `.اضف فار عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
ارسـل احـد الاوامـر اعـلاه""",
        buttons=[
            [Button.inline("رجـوع", data="extras")],
        ],
    link_preview=False)
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر الستـوريـات 🎆🏖](t.me/ZedThon/9) .
**- الامـر :**
**⪼** `.حالات واتس`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/ZedThon/9) .
**- الامـر :**
**⪼** `.بنات`
...
ٴ┄─┄─┄─┄┄─┄─┄─┄─┄┄
**⪼ اوامـر النشـر الخاصـه بجماعة الاعلانات وكروبات الشراء موجـوده في قائمـة اوامـر السوبـرات**
`.اوامر مكرر1`
**⪼ لـ عـرض اوامـر النشـر التلقائـي (.مكرر1) المحدثه بدون بانـد ...✓**
...
`.اوامر النشر`
**⪼ لـ عـرض اوامـر النشـر التلقائـي الاضافيه + المحدثه بدون بانـد ...✓**
ٴ┄─┄─┄─┄┄─┄─┄─┄─┄┄
**- امـر النشـر القديـم (.مكرر) :**
...
async def zed_help(event):
    await event.edit(
        ...
        buttons=[
            ...
            [Button.inline("رجـوع", data="toolzed")],
        ],
    link_preview=False)
...
""",
        buttons=[
            [Button.inline("رجـوع", data="nexttools")],
        ],
    link_preview=False)
...
`.الغاء اختصار https://da.gd/rm6qri`""",
        buttons=[
            [Button.inline("رجـوع", data="urltools")],
        ],
    link_preview=False)
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر الاشتــراك الاجبــاري 🛗](t.me/ZedThon/9) .
**- الامـر :**
...
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"ZChecker")))
@check_owner
async def zed_help(event):
    zelzal = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة المسـاعـدة 👇\n\n⤶ ارســل (.مساعده) في اي مجمـوعـه"
    try:
        await event.edit(
            "ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر الصيـد & التثبيت 🎡\n⋆┄─┄─┄─┄┄┄──┄┄┄─┄─┄─┄⋆\n**✧ اليك عـزيـزي شـࢪوحـات اوامـر الصيـد & التثبيت :**\n\n",
            buttons=[
                [
                    Button.inline("اوامــر الصيــد", data="hunntzed"),
                ],
                [
                    Button.inline("الصيـد المخصص", data="chuntzed"),
                ],
                [
                    Button.inline("اوامــر التثبيت", data="phuntzed"),
                ],
                [
                    Button.inline("رجـوع", data="ZEDHELP"),
                ],
...
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"hunntzed")))
@check_owner
async def _(event):
    await event.edit(
        """ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر الصيـد 🎡
⋆┄─┄─┄─┄┄┄──┄┄┄─┄─┄─┄⋆
...
**- الوصـف :**
اوامـر تشيكـر (صيـد) يـوزرات تيليجـرام مميـزه""",
        buttons=[
            [Button.inline("رجـوع", data="ZChecker")],
        ],
    link_preview=False)

@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"chuntzed")))
@check_owner
async def _(event):
    await event.edit(
        """ᯓ 𝗭𝗧𝗵𝗼𝗻 - الصيـد المخصص 🎡
⋆┄─┄─┄─┄┄┄──┄┄┄─┄─┄─┄⋆
...
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"phuntzed")))
@check_owner
async def _(event):
    await event.edit(
        """ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر التثبيت 🎡
⋆┄─┄─┄─┄┄┄──┄┄┄─┄─┄─┄⋆
**✾ قـائمـة اوامـر تشيكـر صيـد يـوزرات تيليجـرام :** 
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𝗭𝗧𝗵𝗼𝗻 - اوامــر تجميـع النقـاط 💡](t.me/ZedThon/9) .\n\n**✧ اليك عـزيـزي شـࢪوحـات اوامـر تجميـع النقـاط :**\n\n",
        buttons=[
            [
...
`.راتب وعد 50`""",
        buttons=[
            [Button.inline("رجـوع", data="pointzed")],
        ],
    link_preview=False)
...
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"ZEDVIP")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗩𝗶𝗽 🌟 القسـم المدفـوع](t.me/ZedThon/9) .
⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆
**✾ لـ الإشتـراك في القسـم المـدفـوع**
**✾ اسعـار اشتـراكـات اضغـط ع الرابـط**
**- https://t.me/ZedThon/9** 
""",
        buttons=[
            [Button.inline("رجـوع", data="ZEDHELP")],
        ],
