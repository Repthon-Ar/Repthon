...
ZelzalHunter_cmd = (
    "ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الصيـد 🎡\n"
    "⋆┄─┄─┄─┄┄┄──┄┄┄─┄─┄─┄⋆\n"
    ...
    "**- انضـم للقنـاة ~ @RRRDB**\n"
    "**⪼ لـ رؤيـة بعـض اليـوزرات التي قام بصيدهـا بعض منصبيـن زدثــون .. سابقـاً**\n\n"
)

ZelzalCustom_cmd = (
"ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - الصيـد المخصص 🎡\n"
"⋆┄─┄─┄─┄┄┄──┄┄┄─┄─┄─┄⋆\n"
...
ZelzalPin_cmd = (
    "ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التثبيت 🎡\n"
    "⋆┄─┄─┄─┄┄┄──┄┄┄─┄─┄─┄⋆\n"
    "**✾ قـائمـة اوامـر تشيكـر صيـد يـوزرات تيليجـرام :** \n\n"
    "`.تثبيت_قناة` + اليوزر\n"
...
ZelzalType_cmd = (
"𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗭𝗧𝗵𝗼𝗻 - أنـواع اليـوزرات](t.me/ZedThon/9) 𓆪\n\n"
...
async def zhunter_cmd(zelzallll):
    await edit_or_reply(zelzallll, ZelzalHunter_cmd)

@zedub.zed_cmd(pattern="(اوامر المخصص|المخصص)")
async def zcustom_cmd(zelzallll):
    await edit_or_reply(zelzallll, ZelzalCustom_cmd)

@zedub.zed_cmd(pattern="اوامر الصيد")
async def zchecker_cmd(zelzallll):
    await edit_or_reply(zelzallll, ZelzalChecker_cmd)

@zedub.zed_cmd(pattern="اوامر التثبيت")
async def zpin_cmd(zelzallll):
    await edit_or_reply(zelzallll, ZelzalPin_cmd)

@zedub.zed_cmd(pattern="(النوع|الانواع)")
async def ztype_cmd(zelzallll):
    await edit_or_reply(zelzallll, ZelzalType_cmd)


@zedub.zed_cmd(pattern="مخصص (.*)")
async def customhunter(event):
        ...
        if replly and replly.text.startswith('@'):
            ...
            ch = await zedub(
                functions.channels.CreateChannelRequest(
                    ...
                    about=f"This channel to custom hunt username by - @ZedThon | {zuz}",
                )
            )
            try:
    ...
    srys[0] = 0
    #srys = ""
    return await zedub.send_message(event.chat_id, "**- تم الانتهاء من الصيد المخصص .. بنجـاح ✅**")
...
async def hunterusername(event):
    ...
    trys[0] = 0
    #trys = ""
    return await zedub.send_message(event.chat_id, "**- تم الانتهاء من الصيد .. بنجـاح ✅**")
    ...
    try:
        ...
        ch = await zedub(
            functions.channels.CreateChannelRequest(
                ...
                about=f"تم تثبيت اليـوزر بواسطـة سـورس زدثـــون - @ZedThon | {zuz} ",
            )
        )
        try:
            ch = ch.updates[1].channel_id
    ...
    while cmodels:
        ...
        if "Available" in isav:
            try:
                ...
                break
            except FloodWaitError as zed: #Code by t.me/ZlZZ7
                wait_time = zed.seconds
                await sleep(wait_time + 10)
                pass
...
async def _(event):
    ...
    zzzby = "تم تثبيت اليـوزر بواسطـة سـورس زدثـــون - @ZedThon "
    while bmodels:
        ...
        if "Available" in isac:
            try:
                ...
                if "20 bots" in str(eee): # تبعي
                    ...
                    #await zedub.send_message(event.chat_id, f"**• خطأ بتثبيت اليـوزر** {username} ؟!\n**• الخطأ:**\n{str(eee)}\n\n**• تم إيقاف عملية تثبيت هذا اليوزر ✖️**")
                    break
        else:
            pass
        brys[0] += 1
...
@zedub.zed_cmd(pattern="حالة مخصص")
async def _(event):
    if "on" in issclim:
